...
SECRET_KEY = 'django-insecure-t*l9_=ib*ab!wg_n^a=!g(j7_1*7qrpc8fz188!ya7ju_-i&uo'
...
# Paramètres de vérification des emails
ACCOUNT_EMAIL_VERIFICATION = 'mandatory'  # Email de confirmation nécessaire
...
PASSWORD_RESET_TIMEOUT_DAYS = 1  # Temps de validité du lien de réinitialisation
